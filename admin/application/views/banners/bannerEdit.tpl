<div class="panel panel-default">
    <div class="panel-heading">
            ...
            <ul class="nav nav-pills pull-right">
  				<li role="presentation"><a href="{$ADMIN_DIR}/banners/list/">List</a></li>
  				<li role="presentation"><a href="{$ADMIN_DIR}/banners/addbanner/">Add new</a></li>
			</ul>
...
<form action="" method="post" class="form-horizontal">
    ...
    <div class="form-group">
        <div class="col-sm-offset-2 col-sm-10">
           <input type="submit" class="btn btn-primary" value="Update" name="updateBanner" />
        </div>
    </div>
