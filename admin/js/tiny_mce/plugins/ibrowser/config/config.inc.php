...
//	$cfg['ilibs_dir'] 	   = array('/projects/iBrowser/pictures/');		
	$cfg['ilibs_dir'] 	   = array($SiteHostname.'/images/upload/');		
...
//	$cfg['ilibs_inc']      = realpath(dirname(__FILE__) . '/../scripts/rdirs.php'); 	// file to include in ibrowser.php (useful for setting $cfg['ilibs] dynamically
	...
	$cfg['base_dir'] 	= $SiteHostname; 							// base url; e.g. 'http://localhost/'	
