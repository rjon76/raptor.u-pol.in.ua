<?php
	...
	$SiteHostname = isset($_REQUEST['sitehostname']) ? $_REQUEST['sitehostname'] : '';
	$SiteDir = isset($_REQUEST['sitedir']) ? $_REQUEST['sitedir'] : '';
...
// ============================================================
	function insertImage() {
		...
		if (!args.action) { // if not popup	mode, check whether there is a valid image selected		
			...
			if ('<?php echo $cfg['truncrootdir']; ?>' == true) { // create full url incl. e.g. http://localhost....
	//		var SiteDir;
//			alert(SiteDir);
				var root_dir = '<?php echo $cfg['root_dir']; ?>';
				args.src = args.src.substr(root_dir.length-1, args.src.length);				
			}
          ...
          <div id="mainDiv">
            ...
            <div id="inDiv" class="showit">
              ...
              <div id="poDiv" class="hideit">
                ...
                <div class="rowDiv">
                  ...
                  <input class="fldlg" id="popSrc" name="popSrc" type="text" value="" disabled="true" readonly/>
                </div>
                <div class="rowDiv">
                  <div class="btnRight">
                ...
                <div id="fileDiv" class="showit">
                  ...
                  <div id="fiDelDiv" class="hideit">
                    <div class="rowDiv">
                      ...
                      <input class="fldlg readonly" id="in_delinfo" name="in_delinfo" type="text" value="" disabled="true" readonly />
                    </div>
                  </div>
                  <?php }; ?>
                  <?php if ($cfg['rename']) { ?>
            ...
            <div id="atDiv" class="hideit">
              ...
              <div class="rowDiv">
                ...
                <input class="fldlg readonly" id="pr_src" name="pr_src" type="text" value="" disabled="true" readonly />
              </div>
              <div class="rowDiv">
                <div class="btnRight">
              ...
              <div class="floatWrap">
                ...
                <div class="colLeft">
                  ...
                  <div class="rowDiv">
                    ...
                    <input class="fldsm readonly" id="pr_size" name="pr_size" type="text"value="" maxlength="8" disabled="true" readonly />
                  ...
                  <div class="rowDiv">
                    ...
                    <input id="pr_width" name="pr_width" type="text"value="" maxlength="4" <?php if ($cfg['attrib'] != true) {; ?> class="fldsm readonly" disabled="true" readonly <?php } else {; ?> class="fldsm" onchange="changeDim(0);" onkeyup="RemoveInvalidChars(this, '[^0-9]');" <?php }; ?> />
                    <span class="frmText"> (px) </span>
                  </div>
                  <div class="rowDiv">
                    <label for="pr_height"> <span class="pad10"> <?php echo $l->m('at_024'); ?> </span> </label>
                    <input id="pr_height" name="pr_height" type="text"value="" maxlength="4" <?php if ($cfg['attrib'] != true) {; ?> class="fldsm readonly" disabled="true" readonly <?php } else {; ?> class="fldsm" onchange="changeDim(1);" onkeyup="RemoveInvalidChars(this, '[^0-9]');" <?php }; ?> />
                    <span class="frmText"> (px) </span>
                  </div>
                  <div class="rowDiv">
