...
// ================================================	
	...
	function iBrowser_open() {	
		...
		if (ib.isMSIE) { // IE
			...
			var wnd = window.open(ib.baseURL + '?editor=' + ib.editor + '&callback=iBrowser_callback&sitehostname='+ib.SiteHostname+'&sitedir='+ib.SiteDir, 'ibrowser', 'status=no, modal=yes, width=625, height=530');
